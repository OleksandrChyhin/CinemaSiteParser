namespace CinemaSiteParser.Shared
{
    public class Constants
    {
        public class Regex
        {
            public const string HEADER_REGEX = "<h1>.+<s";
            ...
            public const string CAST_REGEX = "<dd>\\w+\\s\\w+,(\\s\\w+\\s\\w+,)+\\s\\w+\\s\\w+</dd>";

            public const string DIRECTORS_REGEX = "<dd>\\w+\\s\\w+</dd>|<dd>\\w+\\s\\w+,\\s(\\w+\\s\\w+,)+\\s\\w+\\s\\w+</dd>";

            public const string SCRIPT_AUTHORS_REGEX = "<dd>\\w+\\s\\w+</dd>|<dd>\\w+\\s\\w+,\\s(\\w+\\s\\w+,)+\\s\\w+\\s\\w+</dd>";
            ...
            public const string DESCRIPRION_REGEX = "\\n.+\\.\"\"";
        }
